...
/* BATCH PATCH PENCEGAT APP_ZYGOTE */
static bool is_sucompat_caller_app_zygote(void)
{
...
{
	/* MODIFIKASI: Tolak semua otorisasi hook jika pemanggil terdeteksi sandbox app_zygote */
	if (unlikely(is_sucompat_caller_app_zygote()))
		return false;
